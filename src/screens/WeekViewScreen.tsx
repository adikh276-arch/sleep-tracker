...
export default function WeekViewScreen({ onBack }: WeekViewScreenProps) {
  ...
  const getDayLabelsForWeek = () => {
    ...
    for (let i = 6; i >= 0; i--) {
      ...
      labels.push(["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"][dayIdx]);
    }
    return labels;
  };
  ...
  return (
    <div className="page-transition-enter px-5 pt-10 pb-8 max-w-md mx-auto">
      <h1 className="font-heading text-2xl mb-6">This Week</h1>
      ...
      <div className="bg-card rounded-lg shadow-soft p-5 mb-6 text-center">
        <p className="text-sm text-muted-foreground font-section">Weekly Average</p>
